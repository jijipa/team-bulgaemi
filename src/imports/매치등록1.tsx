import svgPaths from "./svg-uromjmunw7";
...
function Frame3() {
  return (
    <div className="bg-[#242b35] flex-[1_0_0] h-[52px] min-h-px min-w-px relative rounded-bl-[8px] rounded-tl-[8px]">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] relative size-full">
          <p className="font-['Pretendard:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] text-white tracking-[-0.36px]">축구</p>
        </div>
      </div>
    </div>
  );
...
function Frame4() {
  return (
    <div className="flex-[1_0_0] h-[52px] min-h-px min-w-px relative rounded-br-[8px] rounded-tr-[8px]">
      <div aria-hidden="true" className="absolute border border-[#242b35] border-solid inset-0 pointer-events-none rounded-br-[8px] rounded-tr-[8px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] relative size-full">
          <p className="font-['Pretendard:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#242b35] text-[18px] tracking-[-0.36px]">풋살</p>
        </div>
      </div>
    </div>
  );
...
function Frame20() {
  return (
    <div className="relative shrink-0 size-[24px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Frame 79">
          <path d="M16 19.5L8 12L16 4.5" id="Vector" stroke="var(--stroke-0, #242B35)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function BtnMoreMatch1() {
  return (
    <div className="content-stretch flex items-center justify-center relative size-[40px]" data-name="btn-more match">
      <Frame20 />
    </div>
  );
}
    ...
    <div className="h-[52px] relative rounded-[5px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[12px] pr-[8px] relative size-full">
          <p className="font-['Pretendard:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1a1a1c] text-[16px]">11vs11</p>
          <div className="flex items-center justify-center relative shrink-0 size-[40px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
      <p className="font-['Pretendard:Medium',sans-serif] leading-[0] not-italic relative shrink-0 text-[#54545c] text-[0px] text-[14px] tracking-[-0.28px] w-full whitespace-pre-wrap">
        <span className="leading-[normal] text-[#1a1a1c]">매치 인원 수</span>
...
function Frame9() {
  return (
    <div className="h-[52px] relative rounded-[5px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[12px] pr-[8px] relative size-full">
          <p className="font-['Pretendard:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1a1a1c] text-[16px]">4쿼터</p>
          <div className="flex items-center justify-center relative shrink-0 size-[40px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="-rotate-90 flex-none">
              <BtnMoreMatch2 />
            </div>
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
      <p className="font-['Pretendard:Medium',sans-serif] leading-[0] not-italic relative shrink-0 text-[#54545c] text-[14px] tracking-[-0.28px] w-full whitespace-pre-wrap">
        <span className="leading-[normal] text-[#1a1a1c]">쿼터 수</span>
        <span className="leading-[normal]">{` `}</span>
        <span className="leading-[normal] text-[#d6253c] tracking-[-0.32px]">*</span>
      </p>
      <Frame9 />
    </div>
  );
...
function Frame10() {
  return (
    <div className="h-[52px] relative rounded-[5px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[12px] pr-[8px] relative size-full">
          <p className="font-['Pretendard:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1a1a1c] text-[16px]">25분</p>
          <div className="flex items-center justify-center relative shrink-0 size-[40px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
            <div className="-rotate-90 flex-none">
              <BtnMoreMatch3 />
            </div>
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[4px] relative w-full">
          <p className="flex-[1_0_0] font-['Pretendard:Medium',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#767681] text-[13px] tracking-[-0.26px] whitespace-pre-wrap">1쿼터 기준으로 선택해주세요.</p>
        </div>
      </div>
    </div>
  );
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
      <p className="font-['Pretendard:Medium',sans-serif] leading-[0] not-italic relative shrink-0 text-[#54545c] text-[14px] tracking-[-0.28px]">
        <span className="leading-[normal] text-[#1a1a1c]">쿼터 시간</span>
        <span className="leading-[normal]">{` `}</span>
        <span className="leading-[normal] text-[#d6253c] tracking-[-0.32px]">*</span>
      </p>
      <Frame10 />
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-0 top-[113px] w-[393px]">
      <Frame12 />
      <Frame13 />
    </div>
  );
