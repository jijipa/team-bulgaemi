import svgPaths from "./svg-uo048rbobw";
...
function Frame() {
  return (
    <div className="absolute h-[48px] left-0 right-0 top-0">
      <BtnMoreMatch />
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[48px] items-start left-0 top-[78px] w-[393px]">
      <Frame4 />
      <Frame12 />
      <Frame26 />
    </div>
