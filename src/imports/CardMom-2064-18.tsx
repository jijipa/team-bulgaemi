import svgPaths from "./svg-63gix63taq";

function Mom() {
  return (
    <div className="absolute h-[33.488px] left-[35px] top-[11px] w-[126.583px]" data-name="MOM">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 126.583 33.488">
        <g id="MOM">
          <path d={svgPaths.p218d7f80} fill="url(#paint0_linear_2064_22)" id="Vector" />
          <path d={svgPaths.p105dcb80} fill="url(#paint1_linear_2064_22)" id="Vector_2" />
          <path d={svgPaths.p18310970} fill="url(#paint2_linear_2064_22)" id="Vector_3" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2064_22" x1="155.264" x2="-52.736" y1="-4.156" y2="39.844">
            <stop stopColor="#9EF7FF" stopOpacity="0.7" />
            <stop offset="1" stopColor="#D7BCF4" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_2064_22" x1="155.264" x2="-52.736" y1="-4.156" y2="39.844">
            <stop stopColor="#9EF7FF" stopOpacity="0.7" />
            <stop offset="1" stopColor="#D7BCF4" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_2064_22" x1="155.264" x2="-52.736" y1="-4.156" y2="39.844">
            <stop stopColor="#9EF7FF" stopOpacity="0.7" />
            <stop offset="1" stopColor="#D7BCF4" stopOpacity="0" />
          </linearGradient>
        </defs>
    ...
    <div className="absolute left-[89px] size-[76px] top-[27px]" data-name="icon-number">
      <div className="absolute inset-[-0.33%_-3.69%_-10.86%_-11.62%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 87.635 84.5001">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="84.5001" id="filter0_d_2062_111" width="87.635" x="-2.38419e-07" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2062_111" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_2062_111" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
