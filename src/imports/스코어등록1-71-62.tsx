import svgPaths from "./svg-ik04nqhf85";
  ...
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g clipPath="url(#clip0_71_66)" id="Layer_1">
          <path d={svgPaths.p35e3f600} fill="var(--fill-0, #6E7783)" id="Vector" />
          <path d={svgPaths.p1108d0e4} fill="url(#paint0_linear_71_66)" id="Vector_2" />
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_71_66" x1="23.99" x2="23.99" y1="3.59" y2="45">
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Layer_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_71_86)" id="Layer_1">
          <g id="Vector" />
